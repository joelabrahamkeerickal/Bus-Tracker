...
if(!empty($_GET['status'])){
    switch($_GET['status']){
        case 'succ':
            ...
            $statusMsg = 'Route Contacts list has been added successfully.';
            break;
        case 'err':
...
<div class="wrapper">
  ...
  <div class="content-wrapper" >
    ...
    <?php if(!empty($statusMsg)&&($statusMsg=='Route Contacts list has been added successfully.')){
		...
		echo '<section class="content">
				  ...
				  <h1 class="box-title"><label>All Route Contacts</label></h1>
				  </div>
				  <div class="box-body">
				  <table class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <th>PrimaryNumber</th>
                      <th>Contact1Name</th>
                      <th>Contact1Number</th>
                      <th>Contact2Name</th>
					  <th>Contact2Number</th>
                      <th>Stop Name</th>
                      <th>Status</th>
                    </tr>
					</thead>
                    ...
                    <tr>
                      ...
                      <td><?php echo $row['number_1']; ?></td>
					  <td><?php echo $row['name_2']; ?></td>
                      <td><?php echo $row['number_2']; ?></td>
    ...
    <section class="content">
	   <div class="row">
        ...
        <div class=" col-lg-12 ">
          ...
          <div class="box box-primary">
            <div class="box-header with-border ">
              <h1 class="box-title"><label>Add Route Contacts List</label></h1>
            </div>
			
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="import_route_contacts.php" method="post" enctype="multipart/form-data" id="importFrm">
              <div class="box-body">
			  <div class="row">
			  <div class="col-sm-1"></div>
				...
				<div class="form-group col-sm-3">
                  <input type="text" placeholder="routeName_busNumber" class="form-control" required>
                </div>
				</div>
