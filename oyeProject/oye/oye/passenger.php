...
if(!empty($_GET['status'])){
    switch($_GET['status']){
        case 'succ':
            ...
            $statusMsg = 'Passenger list has been added successfully.';
...
<div class="wrapper">
  ...
  <div class="content-wrapper" >
    ...
    <?php if(!empty($statusMsg)&&($statusMsg=='Passenger list has been added successfully.')){
		...
		echo '<section class="content">
				  ...
				  <h1 class="box-title"><label>All Passengers</label></h1>
				  </div>
				  <div class="box-body">
    ...
    <section class="content">
	   <div class="row">
        ...
        <div class=" col-lg-12 ">
          ...
          <div class="box box-primary">
            <div class="box-header with-border ">
              <h1 class="box-title"><label>Add Passenger List</label></h1>
            </div>
			
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="import_passenger.php" method="post" enctype="multipart/form-data" id="importFrm">
              <div class="box-body">
			  <div class="row">
